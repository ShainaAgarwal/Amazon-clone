...
export default function AdminDashboard() {
  ...
  const fetchInventory = () => {
    ...
    axios.get('https://amazon-clone-fgea.onrender.com/api/admin/users', { headers: { Authorization: `Bearer ${token}` } })
      .then(res => setUsers(res.data))
      .catch(err => console.error(err));

    axios.get('https://amazon-clone-fgea.onrender.com/api/admin/orders', { headers: { Authorization: `Bearer ${token}` } })
      .then(res => setOrders(res.data))
      .catch(err => console.error(err));

    axios.get('https://amazon-clone-fgea.onrender.com/api/admin/products', { headers: { Authorization: `Bearer ${token}` } })
  ...
  const handleAddProduct = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://amazon-clone-fgea.onrender.com/api/admin/products', productData, {
